...
function Top() {
    ...
    function getdata() {
        fetch(`https://api.themoviedb.org/3/movie/${up?up:"upcoming"}?api_key=4e44d9029b1270a757cddc766a1bcb63&language=en-US`)
            .then((res) => res.json())
            .then((data) => {
    ...
    return (
        <div className="p-1 bg-dark" style={{paddingTop:'1px',paddingBottom:'100px'}}>
            <div style={{ marginTop: '100px' }}>
                <h1 style={{ color: 'white', marginLeft: '150px' }}>UPCOMING</h1>
